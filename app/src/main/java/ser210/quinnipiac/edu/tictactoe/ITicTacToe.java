...
public interface ITicTacToe {
    ...
    /**
     * Sets the given player at the given location on the game board. The
     * location must be available, or the board will not be changed
     *
     * @param player
     *            - HUMAN_PLAYER or COMPUTER_PLAYER
     * @param location
     ...
     *
     * @return PLAYING if still playing, TIE if its a tie, CROSS_WON if X won,
     *         or NOUGH_WON if 0 won
     */
